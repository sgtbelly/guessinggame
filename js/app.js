...
function quest1(){
  ...
  if (question1 === 'no' || question1 === 'n'){
    ...
    userPoints++;}else { alert (' I grew up in Rocky Mount, NC and left at the age of 19 to join the Army');}
...
function quest6(){
  while (question6 !== favNumber && tries <= maxTries) {
    question6 = prompt(user + ' what is my favorite number from 1 to ' + userNumber);tries++;console.log(question6);
